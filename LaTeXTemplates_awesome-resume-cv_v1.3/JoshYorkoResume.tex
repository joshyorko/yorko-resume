...
\position{Site Reliablity Engineer{\enskip\cdotp\enskip}Kubernetes Specialist} % Your expertise/fields
\quote{``Dedicated to mastering the complexities of backend engineering and SRE, ensuring robust and scalable solutions."} % A quote or statement that represents your philosophy or professional approach
